...
//        formatter.currencyCode = "usd" // change currency based on the country
//        formatter.currencySymbol = "$" // change currency symbol based on the country
...
//        formatter.currencySymbol = "$" // change currency symbol based on the country
    ...
    /// Convert a Double into string representation with percentage symbol
    ///  ```
    /// Convert 1.23456 to "1.23%"
    ///  ```
